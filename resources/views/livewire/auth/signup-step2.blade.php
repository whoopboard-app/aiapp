                    ...
                    <div class="space-y-8">
                        <div class="text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                                Email verified: <span class="font-semibold text-green-600 dark:text-green-500">{{ $email }}</span>
                            </p>
                        </div>

                        <form wire:submit.prevent="completeSignup" class="space-y-3">
                            <!-- Workspace Name -->
                            <div>
                                ...
                                @enderror
                                <p class="mt-2 text-xs text-gray-500 dark:text-neutral-400">Your business or team name</p>
                            </div>
                            <!-- End Workspace Name -->
                    ...
                    <div class="space-y-8">
                        <div class="text-center">
                            ...
                            <div class="flex justify-center mb-5">
                                <div class="size-16 bg-red-100 rounded-full flex items-center justify-center dark:bg-red-500/10">
                                    <svg class="size-8 text-red-600 dark:text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
